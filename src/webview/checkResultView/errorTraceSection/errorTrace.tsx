...
export const ErrorTrace = React.memo(({errorinfo, traceId}: ErrorTraceI) => {
    ...
    const {settings, expandStates, setHideModified, setFilter, collapseAllStates, expandAllStates} =
                ...
                <div className="error-trace-options">
                    <VSCodeTextField onChange={(e) => setFilter(e.currentTarget.value)} placeholder="Filter">
                        <span
                            ...
                            onClick={(e: any) => setFilter(e.currentTarget.parentNode.value)}/>
                    </VSCodeTextField>
...
const useSettings = (numberOfStates: number) => {
    ...
    const setExpandValue = (index: number, newValue: boolean) => {
        if (newValue !== expandStates[index]) {
            const newValueArray = [...expandStates];
    ...
    return {settings, expandStates, setHideModified, setFilter, collapseAllStates, expandAllStates};
};
